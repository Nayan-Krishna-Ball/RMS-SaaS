...
export const FOOD_ITEMS: FoodItem[] = [
  {
    ...
    description:
      "Juicy beef burger with double cheese, fresh lettuce, tomato, onions, and our special house sauce served in a toasted brioche bun.",
    ingredients: [
      "100% Beef Patty",
      "Cheddar Cheese",
      "Lettuce & Tomato",
  ...
  },
  {
    ...
    description:
      "Creamy white sauce pasta loaded with seasoned grilled chicken strips, mushrooms, parmesan cheese, and garlic herbs.",
    ingredients: [
      "Penne Pasta",
  ...
  },
  {
    ...
    description:
      "Freshly caught Atlantic salmon fillet pan-seared to perfection, drizzled with a rich lemon butter garlic sauce, served with roasted veggies.",
    ingredients: [
  ...
  },
  {
    ...
    description:
      "Cold, refreshing lemonade freshly squeezed with real lemons, a touch of mint, and served over crushed ice.",
    ingredients: [
  ...
  },
  {
    ...
    description:
      "Indulgent warm chocolate cake with a rich molten lava chocolate center, served with a scoop of premium vanilla ice cream.",
    ingredients: [
  ...
  },
  {
    ...
    description:
      "Crispy romaine lettuce tossed with creamy Caesar dressing, garlic croutons, and freshly grated parmesan cheese flakes.",
    ingredients: [
      "Romaine Lettuce",
      "Caesar Dressing",
      "Garlic Croutons",
